...
profileButton.addEventListener("click", () => {
    ...
    const isProfileExpanded = profileDropdown.classList.contains("hidden")
        ? "false"
        : "true";
...
function clickBody() {
    ...
    const isProfileExpanded = profileDropdown.classList.contains("hidden")
        ? "false"
        : "true";
    const isProfilemenu = mobileMenu.classList.contains("hidden")
        ? "false"
        : "true";
    if (isProfileExpanded) mobileMenu.classList.add("hidden");
    if (isProfilemenu) profileDropdown.classList.add("hidden");
}
