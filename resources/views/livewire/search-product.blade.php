<div>
    <div class="mt-8 space-y-4 px-4">
        ...
        @if (sizeof($products) > 0)
            <table class="h-screen w-full table-auto border-collapse text-sm">
                <thead>
                    <tr>
                ...
                <tbody class="dark:bg-slate-800 bg-white">
                    @foreach ($products as $product)
                        <tr class="my-4 py-4 odd:bg-white even:bg-gray-200">
                            ...
                            <td class="flex">
                                <a class="btn btn-primary m-2"
                                    href="{{ route('products.edit', ['product' => $product->id]) }}" wire:navigate>
                                    <x-svg.eye />
                                </a>
                                <form method="POST"
